    ...
    <div className="footer">
      <Container>
          ...
          <Col>
            <div className="mobile">
              ...
              <div className="stores">
                <a>
                  <svg
                    class="MuiSvgIcon-root jss83"
                    focusable="false"
                    viewBox="0 0 128 36.7"
                    aria-hidden="true"
                    version="1.1"
                    id="Layer_1"
                    x="0px"
		...
		c0.8-1,1.9-1.5,3.2-1.5c1.3,0,2.3,0.5,3,1.5c0.5,0.8,0.8,1.8,0.8,2.9C116.6,24.7,116.6,25.1,116.5,25.3z"
                ...
                <a href="#">
                  <svg
                    class="MuiSvgIcon-root jss84"
                    focusable="false"
                    viewBox="10 10 143 39"
                    aria-hidden="true"
